...
import Character2 from "@/assets/images/characters/character_2.webp";
...
export default function BannerSvg() {
  ...
  return (
    <>
      ...
      >
        <image href={Character2} height="300" x="312" y="30" />
        <defs>
          <linearGradient
            id="BG"
            x1="140"
          ...
          >
            <stop offset="0%" stopColor={colorPrimary}></stop>
            <stop offset="100%" stopColor={colorPrimary} stopOpacity="0"></stop>
          </linearGradient>
        </defs>
        <path
          fill="url(#BG)"
